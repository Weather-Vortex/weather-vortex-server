...
module.exports.vortex = new Map([
  ...
  { id: 26, description: "Drizzle rain", icon: "mdi-weather-rainy" },
  {
    id: 27,
    description: "Heavy intensity drizzle rain",
    icon: "mdi-weather-rainy",
  },
  { id: 28, description: "Shower rain and drizzle", icon: "mdi-weather-rainy" },
  {
    id: 29,
    description: "Heavy shower rain and drizzle",
    icon: "mdi-weather-rainy",
  },
  { id: 30, description: "Shower drizzle", icon: "mdi-weather-rainy" },
  {
    id: 31,
    description: "Light intensity shower rain",
    icon: "mdi-weather-rainy",
  },
  { id: 32, description: "Shower rain", icon: "mdi-weather-rainy" },
  {
    id: 33,
    description: "Heavy intensity shower rain",
    icon: "mdi-weather-rainy",
  },
  { id: 34, description: "Ragged shower rain", icon: "mdi-weather-rainy" },
  { id: 18, description: "", icon: "mdi-weather-rainy" }, // Reserved for 230
